  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1600px] px-8 lg:px-12">
        ...
        <div className="flex flex-col items-center gap-6 border-y border-[var(--border-soft)] py-12 sm:flex-row sm:justify-between">
          <p className="text-[10px] font-medium uppercase tracking-[0.3em] text-[var(--text-quiet)]/70">
            {t('builtWith')}
          </p>
