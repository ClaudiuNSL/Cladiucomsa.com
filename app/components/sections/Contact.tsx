      ...
      <div className="w-full max-w-5xl">
        <div className="grid gap-16 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-6">
            ...
            <div data-reveal className="mt-12 h-px w-24 bg-[var(--border-soft)]" aria-hidden="true" />
            <p data-reveal className="mt-8 max-w-md text-base leading-[1.6] text-[var(--text-mid)] lg:text-lg">
              {t('subtitle')}
            </p>
            <div data-reveal className="mt-10 space-y-3">
              <p className="text-[10px] font-medium uppercase tracking-[0.3em] text-[var(--text-quiet)]">
                {t('directLabel')}
              </p>
              <a
                href={`mailto:${t('emailValue')}`}
                className="block text-sm text-[var(--text-mid)] transition-colors hover:text-white"
              >
                {t('emailValue')}
              </a>
              <a
