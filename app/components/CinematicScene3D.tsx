    ...
    >
      ...
      >
        ...
        <pointLight
          ...
          color="#ffffff"
        />
        {/* Backlight — creeaza un edge glow pe marginea asteroidului dinspre
            partea opusa camerei. Acopera spatiul "in jurul" lui fara halou
            sprite (care bleed-uia in spatiul gol). */}
        <pointLight
          position={[0, 0.5, -3]}
          intensity={1.4}
          distance={6}
